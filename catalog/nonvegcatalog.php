...
#productGrid2 > b:nth-child(2n){
  grid-column: 1;
}

#productGrid2 > b:nth-child(2n+1){
  grid-column: -2/-1;
}
...
.product>.details, #productGrid2 > b:nth-child(2n+1){
...
.product>.logo, #productGrid2 > b:nth-child(2n){
...
<div id="nonvegmenu" style="width=100%; margin-left: 45%;">
 <h1 >Non-Veg Menu</h1>
 <br>
</div>
 <ul id="productGrid2">
...
<?php
require "api/loadnonvegdata.php";
?>
...
var grid = document.getElementById("productGrid2"); 
var products = document.getElementById("productGrid2").getElementsByClassName("non-veg");
var productsShown;
var spacers;
var nPerRow;
var rowHeight;
...
function resizeGrid(){
  ...
  spacers = document.getElementById("productGrid2").getElementsByTagName("b"); 
